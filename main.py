...
def usernames():
    ...
    x = ''.join(choice("qwertyuiopasdfghjklzxcvbnm1234567890") for i in range(1))
    p = ''.join(choice("qwertyuiopasdfghjklzxcvbnm1234567890") for i in range(1))
    t = ''.join(choice("t") for i in range(1))
    o = ''.join(choice("o") for i in range(1))
    b = ''.join(choice("b")  for i in range(1)) 
    g = ''.join(choice("xcvnzaswertuio") for i in range(1)) 
